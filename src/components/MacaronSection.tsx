    ...
    >
      ...
      <div className="sticky top-0 h-screen flex items-start pt-20 md:pt-32 overflow-hidden">
        <motion.div className="relative w-full h-full max-w-[1200px] mx-auto px-4 flex flex-col md:flex-row md:items-start">
          ...
          <motion.div
            className="absolute bottom-0 left-4 right-4 md:absolute md:left-auto md:right-[-23%] md:top-[50%] z-30 w-auto max-w-none md:max-w-[55%] p-6 md:p-8 rounded-t-3xl md:rounded-3xl shadow-2xl backdrop-blur-xl border border-white/50 overflow-hidden md:mt-0"
            style={{
              background:
