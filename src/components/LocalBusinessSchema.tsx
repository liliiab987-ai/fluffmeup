...
export default function LocalBusinessSchema() {
  const schemaData = {
    ...
    name: "Fluff Me Up",
    image: [
      "https://fluffmeup.com/logof.webp",
      "https://fluffmeup.com/macaroncake.webp",
      "https://fluffmeup.com/fluffcafe.webp",
    ],
    "@id": "https://fluffmeup.com",
    ...
    priceRange: "$$",
    servesCuisine: ["Coffee", "French", "Desserts"],
    menu: "https://fluffmeup.com/menu",
  };
